...
e2e:
	cargo test --test e2e_smoke --test e2e_recipes --test e2e_label --test e2e_validation --test e2e_flows --test e2e_ux --test e2e_declaration_feedback --test e2e_i18n --test e2e_wildsammlung_layout --test e2e_eggs -- --nocapture --test-threads=1
