...
/// Crossed-out eye — marks a field whose value stays internal (not printed on the label).
#[component]
...
pub fn Share() -> Element {
    rsx! {
        svg {
            ...
            class: "w-6 h-6",
            path { fill: "none", stroke: "none", d: "M0 0h24v24H0z" }
            // Drei Knoten, verbunden durch zwei Linien: das gelaeufige
            // Teilen-Zeichen, im selben Tabler-Stil wie die uebrigen Icons.
...
#[component]
pub fn KnospeMark(class: String) -> Element {
    rsx! {
        svg {
            class: "{class}",
            view_box: "22 3 50 50",
...
#[component]
pub fn KnospeCompactCh() -> Element {
    let label = t!("bio_labels.knospe_icon_ch").to_string();
    rsx! {
        svg {
            ...
            path {
                d: "M 25.27785,38.6574 c -8.3625,4.5675 -6.28,9.895 -0.0613,12.86125 7.335,3.50125 21.9925,5.2225 29.05125,2.47 C 41.27155,54.6899 29.6553,50.1274 25.2778,38.6574",
                style: "fill:#e2001a",
            }
        }
    }
...
/// Compact Knospe icon without Swiss cross for inline use (ingredient list).
#[component]
pub fn KnospeCompactNoCross() -> Element {
    let label = t!("bio_labels.knospe_icon_no_cross").to_string();
    rsx! {
        svg {
            class: "w-5 h-5 flex-shrink-0",
            view_box: "22 3 50 52",
