...
fn parse_form_from_saved_params(params: &str) -> Option<Form> {
    ...
    let mut form = from_query_string::<Form>(&decoded_query_string).ok()?;
    if form.v < 2 {
        for ingredient in &mut form.ingredients {
...
#[component]
pub fn LabelPage(configuration: Configuration) -> Element {
    ...
    let configuration = use_signal(|| configuration);
    ...
    let has_cert = configuration.read().has_certification_body();
    ...
    rsx! {
                ...
                div {
                    ...
                    div { class: "flex flex-col gap-6 p-8 pb-12",
                        FormField {
                            ...
                            help: Some(t!("help.produktname").to_string()),
                            TextInput {
                        ...
                        FormField {
                            ...
                            help: Some(t!("help.sachbezeichnung").to_string()),
                            required: true,
                            TextInput {
                        ...
                        if !ignore_ingredients() {
                            FormField {
                                ...
                                help: Some(t!("help.zutaten").to_string()),
                                required: true,
                                IngredientsTable {
                                    ingredients: ingredients,
                        ...
                        FieldGroup2 {
                            FormField {
                                ...
                                help: Some(t!("help.datumseingabe").to_string()),
                                DateInput {
                                    date_value: date,
                                    date_prefix: date_prefix
                                }
                            ...
                            FormField { label: t!("label.zusatzinformationen").to_string(),
                                help: Some(t!("help.zusatzinformationen").to_string()),
                                TextareaInput {
                        ...
                        FieldGroup2 {
                            FormField {
                                ...
                                help: Some(t!("help.aufbewahrungshinweis").to_string()),
                                TextareaInput{
                                    rows: "2",
        ...
        LabelPreview {
            ...
            producer_phone: producer_phone,
            producer_website: producer_website,
            certification_body: if has_cert { Some(certification_body) } else { None },
            amount_type: amount_type,
            weight_unit: weight_unit,
            volume_unit: volume_unit,
            amount: amount,
